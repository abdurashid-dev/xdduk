...
@section('content')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Sahifa yaratish</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Sahifa yaratish</li>
            </ol>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Sahifa yaratish</h3>
                        </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            name="menu_id"
                                            style="width: 100%;">
                                            <option selected disabled value="">Menyu tanlang</option>
