                ...
                <div class="col">
                                        ...
                                        <div class="col-auto">
                                            <ul class="nav nav-pills ml-auto p-2">
                                                ...
                                                <li class="nav-item"><a href="{{($user->role == 'user1')?route('admin.profile.password'):route('admin.profile.password.index')}}"
                                                                        class="nav-link {{request()->is('/password')? 'active':''}}"><i
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form id="w0" action="{{($user->role == 'user1')? route('admin.data') : route('admin.data.index')}}" method="post">
                                        @csrf
                                        <div class="form-group field-usersettingsform-username required">
                                            <label for="usersettingsform-username">FIO</label>
                                            <input type="text" id="usersettingsform-username" class="form-control"
                                                   name="name" value="{{$user->name}}" aria-required="true">

                                            <div class="invalid-feedback"></div>
                                        </div>
                                        <div class="form-group field-usersettingsform-phone required">
                                            <label for="usersettingsform-phone">Email</label>
                                            <input type="text" id="usersettingsform-phone" class="form-control"
                                                   name="email" value="{{$user->email}}" aria-required="true">
