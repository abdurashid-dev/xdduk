                        ...
                        <div class="tab-content" id="custom-tabs-three-tabContent">
                            <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="time_uz"
                                           placeholder="Ish kunlarini(uz) kiriting" value="{{$leader->time_uz}}">
                                </div>
                                @error ('time_uz')
                                <p class="text-danger">* {{$message}}</p>
                                @enderror
                                ...
                                <div class="form-floating mt-3">
                                    <textarea id="bio_uz" name="bio_uz" required>{{$leader->bio_uz}}</textarea>
                                    @error ('bio_uz')
                                    <p class="text-danger">* {{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="time_en"
                                           placeholder="Ish kunlarini(en) kiriting" value="{{$leader->time_en}}">
                                </div>
                                @error ('time_en')
                                <p class="text-danger">* {{$message}}</p>
                                @enderror
                                ...
                                <div class="form-floating mt-3">
                                    <textarea id="bio_en" name="bio_en" required>{{$leader->bio_en}}</textarea>
                                    @error ('bio_en')
                                    <p class="text-danger">* {{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-messages" role="tabpanel"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="time_ru"
                                           placeholder="Ish kunlarini(en) kiriting" value="{{$leader->time_ru}}">
                                </div>
                                @error ('time_ru')
                                <p class="text-danger">* {{$message}}</p>
                                @enderror
                                ...
                                <div class="form-floating mt-3">
                                    <textarea id="bio_ru" name="bio_ru" required>{{$leader->bio_ru}}</textarea>
                                    @error ('bio_ru')
                                    <p class="text-danger">* {{$message}}</p>
                                    @enderror
                                </div>
